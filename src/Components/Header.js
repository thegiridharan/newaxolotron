...
export default function Header() {
    return (
        <div className="flex items-center justify-between p-[20px] bg-black w-[85%] mx-auto fixed inset-0 z-50 h-[55px] md:h-[60px] rounded-full top-[35px]">
            <Image src="/axolotron-logo.png" alt="axolotron-logo" height={50} width={50} quality={100} className="md:h-[16px] md:w-[150px] h-[12px] w-[100px]" />
