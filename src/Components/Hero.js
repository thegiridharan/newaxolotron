            ...
            <div className="relative w-full h-screen overflow-hidden">
                ...
                <div className="relative z-10 text-white px-6 bg-gradient-to-r from-black to-transparent h-full w-full flex items-center justify-start pt-[80px]">
                    <div className="flex-row md:mx-[80px]">
                        <div className={`text-[26px] md:text-6xl font-normal drop-shadow-lg text-start ${oswa.className}`}>
                        ...
                        <p className={`mt-4 max-w-2xl text-[15px] md:text-[20px] drop-shadow-md ${sans.className} text-[#828282]`}>
